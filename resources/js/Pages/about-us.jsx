      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          >
            <h2 className="text-3xl font-bold mb-6 flex items-center">
              ...
              Our <span className="text-green-500 ml-2">Story</span>
            </h2>
          ...
          >
            <h2 className="text-3xl font-bold mb-6 flex items-center">
              ...
              Our <span className="text-green-500 ml-2">Vision</span>
            </h2>
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
        ...
        >
          <h2 className="text-3xl font-bold mb-8">
            Why Choose <span className="text-green-500">Travel Nest</span>?
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div key={index} className="flex items-start p-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-green-400">{value.title}</h3>
        ...
        >
          <h2 className="text-2xl font-bold mb-4">
            Ready to Explore with <span className="text-green-400">Travel Nest</span>?
          </h2>
