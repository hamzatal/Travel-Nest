...
import { 
  ...
  Bell, Settings, LogOut, Grid, Shield,
  Eye, Download, Trash2, Edit, Search,
  CheckCircle, XCircle
} from "lucide-react";
      ...
      <div className="ml-64 p-8">
        ...
        <div className="bg-gray-800 p-4 rounded-lg mb-6">
          <div className="flex items-center space-x-4">
            ...
            <select className="bg-gray-700 text-white rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-2">
                        <button 
                          ...
                          className={`px-3 py-1 rounded-full inline-flex items-center ${user.is_active ? 'bg-red-100 text-red-800 hover:bg-red-200' : 'bg-green-100 text-green-800 hover:bg-green-200'}`}
          ...
          <div className="flex justify-between items-center mt-6 bg-gray-800 rounded-lg px-4 py-3">
            ...
            <div className="flex space-x-1">
              {users.links.map((link, i) => {
                ...
                if ((i === 0 && link.url === null) || (i === users.links.length - 1 && link.url === null)) {
                  return null;
                }
