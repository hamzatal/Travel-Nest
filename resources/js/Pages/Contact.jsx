...
const Contact = ({ auth }) => {
  ...
  const inputClasses = (error) => `
    ...
    ${error ? "border-red-500" : "border-gray-600 hover:border-blue-400"}
  `;
            ...
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-400">support@travelnest.com</p>
                </div>
              </div>
            ...
            <div className="w-full bg-gray-800 bg-opacity-70 rounded-xl p-8 shadow-2xl backdrop-blur-sm border border-gray-700">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      className={`${inputClasses(errors.message)} resize-none h-32`}
                ...
                <motion.button
                  ...
                  type="submit"
                  disabled={processing}
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-all duration-300 flex items-center justify-center group"
                >
                  {processing ? (
                    <div className="flex items-center">
