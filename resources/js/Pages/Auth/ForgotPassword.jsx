...
export default function ForgotPassword({ status }) {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-gray-900 via-gray-800 to-black relative">
      ...
      <Link
        href="/"
        className="fixed top-4 left-4 z-50 flex items-center space-x-2 px-4 py-2 bg-green-600 text-white rounded-full shadow-lg hover:bg-green-700 transition-all"
      >
      ...
      <div className="hidden lg:flex w-1/2 items-center justify-center p-12">
        <div className="text-center space-y-6">
          <MapPin className="w-16 h-16 text-green-500 mx-auto" />
          <h1 className="text-4xl font-bold text-white">
            Welcome to <span className="text-green-500">Travel Nest</span>
          </h1>
