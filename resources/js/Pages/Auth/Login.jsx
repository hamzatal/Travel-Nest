...
const LoginPage = () => {
  ...
  const submit = (e) => {
    ...
    post(route("login"), {
      ...
      onError: (errors) => {
        setNotification({ type: "error", message: errors.email || "Invalid credentials. Try again." });
      ...
      <div className="relative z-10 min-h-screen flex">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8">
          <div className="w-full max-w-md p-8 rounded-xl shadow-xl bg-gray-800/90 backdrop-blur-sm">
            ...
            <p className="text-gray-400 text-center mb-6">Enter your details to continue</p>
