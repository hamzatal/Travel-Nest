    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white transition-all duration-300 relative">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          >
            <h2 className="text-3xl font-bold mb-6 flex items-center">
              ...
              Our <span className="text-blue-500 ml-2">Story</span>
            </h2>
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                Founded by a team of travel enthusiasts in 2020, Travel Nest started with a
                simple idea: to create a platform that inspires and empowers
                travelers from all walks of life.
              </p>
              <p>
                Our founders, having experienced the challenges of travel planning firsthand,
                decided to build a solution that combines cutting-edge technology with personalized
                service to make travel accessible to everyone.
              </p>
              <p>
          ...
          >
            <h2 className="text-3xl font-bold mb-6 flex items-center">
              ...
              Our <span className="text-blue-500 ml-2">Vision</span>
            </h2>
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                We envision a world where travel is not just about destinations, but about 
                transformative experiences that broaden horizons and create lasting memories.
              </p>
              <p>
                Travel Nest aims to be the bridge connecting cultures, people, and places,
                fostering understanding and appreciation of our diverse world.
              </p>
              <p>
                By leveraging innovative technology and our deep passion for exploration,
                we're working to make every journey an enriching adventure that begins the
                moment you visit our platform.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <motion.div 
          ...
          transition={{ duration: 0.5 }}
          variants={fadeIn}
          className="bg-blue-900 bg-opacity-30 rounded-xl p-8 shadow-2xl max-w-4xl mx-auto mb-16 border border-blue-800"
        >
          <h2 className="text-3xl font-bold mb-6 text-center flex items-center justify-center">
            <span className="bg-blue-600 p-2 rounded-full mr-3">
              <Shield className="h-6 w-6" />
            </span>
            Our <span className="text-blue-500 ml-2">Mission</span>
          </h2>
          <div className="text-gray-200 leading-relaxed space-y-4">
            ...
            <p>
              Our commitment extends beyond just facilitating bookings - we're dedicated to:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Promoting sustainable and responsible tourism practices</li>
              <li>Supporting local communities in popular destinations</li>
              <li>Making travel inclusive and accessible to diverse audiences</li>
              <li>Continuously innovating to meet the evolving needs of modern travelers</li>
            </ul>
          </div>
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-gray-300">
                ...
                destinations across six continents and over 180 countries.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-300">
                Book flights, hotels, and experiences with just a few clicks.
                Our intuitive platform ensures hassle-free planning every time.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-300">
                ...
                Travel with confidence knowing we've got your back.
              </p>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              {
                title: "Innovation",
                description: "We embrace new technologies and ideas to continuously improve our service."
              },
              {
                title: "Integrity",
              ...
              {
                title: "Inclusivity",
                description: "We believe travel should be accessible to everyone, regardless of background."
              },
              {
                title: "Sustainability",
                description: "We promote responsible travel practices that respect our planet."
              }
            ].map((value, index) => (
              <div key={index} className="flex items-start p-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-blue-400">{value.title}</h3>
        ...
        <motion.div 
          ...
          transition={{ duration: 0.5 }}
          variants={fadeIn}
          className="text-center bg-blue-900 bg-opacity-40 rounded-xl p-8 shadow-xl max-w-3xl mx-auto border border-blue-800"
        >
          <h2 className="text-2xl font-bold mb-4">
            Ready to Explore with <span className="text-blue-400">Travel Nest</span>?
          </h2>
