...
export default function Index({ auth, offers = [], flash = {} }) {
    ...
    const toggleFavorite = async (offerId) => {
        ...
        try {
            ...
            const { success, message, is_favorite, favorite_id } = response.data;
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white transition-all duration-300 relative">
            ...
            <div className="relative h-80 md:h-96 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-[url('/images/world.svg')] bg-no-repeat bg-center bg-opacity-30 bg-fill"></div>
                ...
                <div className="absolute inset-0">
                    <motion.div
                        ...
                        <Percent className="size-24 w-20 text-amber-200" />
                    </motion.div>
                    <motion.div
                        initial={{ opacity: 0, scale: 0.5 }}
                        animate={{ opacity: 0.15, scale: 1 }}
                        ...
                        className="absolute bottom-1/4 right-1/4 translate-x-1/2 translate-y-1/2">
                            <Tag className="size-20 h-20 text-blue-200" />
                        </motion.div>
                        <motion.div
                            initial={{ opacity: 0, scale: 0.5 }}
                            animate={{ opacity: 0.15, scale: 1 }}
                            ...
                            <Flame className="size-16 h-16 text-red-600" />
                        </motion.div>
                    </div>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center px-4">
                            ...
                            >
                                Exclusive <span className="text-amber-400">Deals</span>
                            </motion.h1>
                            <motion.p
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                ...
                <div className="max-w-7xl mx-auto px-6 md:p-16 px-5">
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.5, delay: 0.2 }}
                        class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-5 bg-gray-800 bg-opacity-50 p-4 rounded-xl border border-gray-700"
                    >
                        ...
                        <div className="flex justify-between items-center mb-6">
                            <p className="text-gray-400">
                                ...
                                {filteredOffers.length > 0
                                    ? filteredOffers.length > (currentPage - 1) * itemsPerPage + 1
                                        : 0}
                                -
                                {Math.min(
                                    currentPage * itemsPerPage,
                                ...
                                >
                                    <div className="max-w-md mx-auto">
                                        ...
                                        <p className="text-gray-400 mb-6">
                                            ...
                                            your search criteria. Try adjusting
                                            ...
                                            <div className="absolute top-4 right-4 flex flex-col gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-200 backdrop-blur-sm ${
                                                        favorites[offer.id].is_favorite
                                        ...
                                        <div className="p-5 flex flex-col">
                                            ...
                                            <div className="mt-auto">
                                                <div className="flex items-center justify-between mb-4">
                                                    <div>
                                                        <span className="block text-gray-400 text-xs text-sm">
                                                            Starting from
                                                        </span>
